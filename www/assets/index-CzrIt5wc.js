 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _k(t,e){if(pe(t.app))return Promise.reject(Ce(t));const n=fe(t),i=await yk(n,{token:e,returnSecureToken:!0}),r=await Et._fromIdTokenResponse(n,"signIn",i);return await n._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kk(t,e,n){const i=fe(t),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){w(a.handleCodeInApp,i,"argument-error"),a&&$l(i,o,a)}s(r,n),await qn(i,r,"getOobCode",nk,"EMAIL_PASSWORD_PROVIDER")}function Tk(t,e){const n=Hr.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function Ak(t,e,n){if(pe(t.app))return Promise.reject(Ce(t));const i=D(t),r=di.credentialWithLink(e,n||to());return w(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),To(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HT(t,e,n){return KT(t,e,n)}async function KT(t,e,n){if(pe(t.app))return Promise.reject(Ce(t));const i=fe(t);Fr(t,e,Sn),await i._initializationPromise;const r=Ui(i,n);return await Hf(r,i),r._openRedirect(i,e,"signInViaRedirect")}function VT(t,e,n){return zT(t,e,n)}async function zT(t,e,n){const i=D(t);if(Fr(i.auth,e,Sn),pe(i.auth.app))return Promise.reject(Ce(i.auth));await i.auth._initializationPromise;const r=Ui(i.auth,n);await Hf(r,i.auth);const s=await V0(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function jT(t,e,n){return WT(t,e,n)}async function WT(t,e,n){const i=D(t);Fr(i.auth,e,Sn),await i.auth._initializationPromise;const r=Ui(i.auth,n);await Wl(!1,i,e.providerId),await Hf(r,i.auth);const s=await V0(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function H0(t,e){return await fe(t)._initializationPromise,K0(t,e,!1)}async function K0(t,e,n=!1){if(pe(t.app))return Promise.reject(Ce(t));const i=fe(t),r=Ui(i,e),o=await new UT(i,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function V0(t){const e=Yl(`${t.uid}:::`);return t._redirectEventId=e,await t.auth._setRedirectUser(t),await t.auth._persistUserIfCurrent(t),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
